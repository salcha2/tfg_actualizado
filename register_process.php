...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($nombre) && !empty($apellido) && !empty($email) && !empty($username) && !empty($password)) {
        ...
        $query = "INSERT INTO usuario (nombre, apellido, email, telefono, institucion, username, password_hash) VALUES ($1, $2, $3, $4, $5, $6, $7)";
        $resultado = pg_query_params($conexion, $query, array($nombre, $apellido, $email, $telefono, $institucion, $username, $password));
